...
**"This is slower than the web interface."** That's normal for single prompts. The speed advantage comes when you process files or chain commands together. Stick with it through Part 4 of the exercise, where you process a local file. That's where the difference becomes clear.
